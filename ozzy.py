...
COIN_POS = [
    (280, 345), (400, 300), (560, 295), (700, 250),
    (840, 245), (960, 310), (1100, 305), (1300, 235),
    (1450, 235), (1620, 275), (1760, 275), (1900, 195),
    (2060, 195), (2200, 195), (2430, 165), (2580, 165),
    (2720, 235), (2860, 235), (3000, 155), (3160, 225),
    (3300, 225), (3440, 145),
]
...
class GameScreen(BaseScreen):
    ...
    def _init_level(self):
        ...
        self._coins  = [CoinItem(cx, cy) for cx, cy in COIN_POS]
        self._projs  = []
        self._parts  = []
        ...
        for c in self._coins:
            ...
            if not c.taken:
                ...
                if self.player.collides(cr[0], cr[1], cr[2], cr[3]):
                    ...
                    self._parts.append(Particle(c.x, c.y, "#ffd700", 8, 3))
